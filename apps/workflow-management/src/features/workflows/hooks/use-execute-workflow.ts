...
const useExecuteWorkflow = ({
    ...
    useEffect(() => {
        ...
        const socket = socketInstance.connect("/", {
            query: { run_id: testRunId }
        });

        socket.emit("join:run", { run_id: testRunId });
        ...
        socket.on(SocketEvent.RunStarted, onRunStarted);
        socket.on(SocketEvent.RunCompleted, onRunCompleted);
        socket.on(SocketEvent.RunFailed, onRunFailed);

        socket.on(SocketEvent.ChildRunStarted, onRunChildRunStarted);
        socket.on(SocketEvent.ChildRunCompleted, onRunChildRunCompleted);

        socket.on(SocketEvent.TaskDispatched, onTaskDispatched);
        socket.on(SocketEvent.TaskCompleted, onTaskCompleted);
        socket.on(SocketEvent.TaskFailed, onTaskFailed);
        socket.on(SocketEvent.TaskRetrying, onTaskRetrying);
        socket.on(SocketEvent.InputRequested, onInputRequested);
        socket.on(SocketEvent.HumanActionRequested, onHumanActionRequested);
        socket.on(SocketEvent.DataEditRequested, onDataEditRequested);

        socket.on(SocketEvent.EdgeTraversed, onEdgeTraversed);
        socket.on(SocketEvent.ConditionEvaluated, onConditionEvaluated);

        return () => {
            socket.emit("leave:run", { run_id: testRunId });

            socket.off("reconnect", handleReconnect);
            socket.off("reconnect_failed", handleReconnectFailed);
            
            socket.off(SocketEvent.RunStarted, onRunStarted);
            socket.off(SocketEvent.RunCompleted, onRunCompleted);
            socket.off(SocketEvent.RunFailed, onRunFailed);
            socket.off(SocketEvent.TaskDispatched, onTaskDispatched);
            socket.off(SocketEvent.TaskCompleted, onTaskCompleted);
            socket.off(SocketEvent.TaskFailed, onTaskFailed);
            socket.off(SocketEvent.TaskRetrying, onTaskRetrying);
            socket.off(SocketEvent.InputRequested, onInputRequested);
            socket.off(
                SocketEvent.HumanActionRequested,
                onHumanActionRequested
            );
            socket.off(SocketEvent.DataEditRequested, onDataEditRequested);
