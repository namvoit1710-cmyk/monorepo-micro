// ============================================================================
// Action Engine — Core Runner
// ============================================================================
// Step router + pipeline runner + public runAction API.
// Each step returns true (continue) or false (stop pipeline).
// Errors jump to onError pipeline if configured.
// ============================================================================
...
/**
 * Execute steps sequentially. Stops if any step returns false.
 */
...
// Inject pipeline runner into flow executors (breaks circular dep)
...
/**
 * Run an action config against an engine context.
 *
 * @param config - ActionConfig with steps and optional onError pipeline
 * @param ctx    - EngineContext with runtime data
 ...
 *     action: "assign_task",
 *     steps: [
 *       { type: "api_call", service: "governance", method: "POST", endpoint: "/api/tasks/${rowData._id}/assign" },
 *       { type: "toast", message: "Assigned!", variant: "success" },
 *       { type: "refetch_data" },
 *     ],
 *   },
 *   ctx,
...
export async function runAction(
    ...
    try {
        ...
        // Run onError pipeline if defined
