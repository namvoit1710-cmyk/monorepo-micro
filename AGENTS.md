...
This project is indexed by GitNexus as **monorepo-micro** (6432 symbols, 11948 relationships, 275 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
